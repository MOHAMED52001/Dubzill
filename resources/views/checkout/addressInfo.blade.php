    ...
    <main>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 order-md-2 mb-4">
                    ...
                    <div id="shipping-price"><span class="text-muted">Shipping: </span><span
        ...
        <script>
            function updateShippingPrice(selectElement) {
                ...
                var finalPrice = parseFloat({{ $totalPriceAfterDiscount }}) + selectedPrice;

                document.getElementById('shipping-price-value').textContent = selectedPrice + ' AED';
                document.getElementById('total-price-value').textContent = totalPrice + ' AED';
                document.getElementById('final-price-value').textContent = finalPrice + ' AED';
            }
        </script>
    </main>
</x-main-layout>
