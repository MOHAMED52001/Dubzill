            ...
            <div class="container-fluid flex-grow-1 container-p-y">
              ...
              <div class="col-xl">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <form action="/admin/area" method="POST" enctype="multipart/form-data">
                        @csrf
                      <div class="mb-3">
                        <label class="form-label" for="basic-default-fullname">Name</label>
                        <input type="text" class="form-control" id="basic-default-fullname" placeholder="area" name="name" value="{{ old('name') }}">
                        @error('name')
                      ...
                      <div class="mb-3">
                        ...
                        <input type="number" step="any" class="form-control" id="basic-default-fullname" placeholder="price" name="price" value="{{ old('name') }}">
                        @error('price')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                      </div>
