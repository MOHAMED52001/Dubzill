            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-md-6 col-sm-12 ">
                    <div class="widget widget_about">
                        ...
                        <h5 class="m-b20">Best car store in UAE</h5>
                        <p>Parts Noon is your Trusted Source for Quality Used Spare Parts in the UAE!</p>
                        <ul class="social-list style-1">
                            <li><a href="/assets/https://www.youtube.com/"><i class="fab fa-youtube"></i></a></li>
                            <li><a href="/assets/https://www.linkedin.com/"><i class="fab fa-linkedin"></i></a></li>
                            <li><a href="/assets/https://twitter.com/"><i class="fab fa-twitter"></i></a></li>
                            <li><a href="/assets/https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a></li>
                            <li><a href="/assets/https://www.instagram.com/"><i class="fab fa-instagram"></i></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="widget widget_categories p-l50">
                        ...
                        <ul>
                            <li class="cat-item"><a href="{{ route('about') }}">About us</a></li>
                            <li class="cat-item"><a href="{{ route('privacy_policy') }}">Privacy Policy</a></li>
                            {{-- <li class="cat-item"><a href="{{ route('contact') }}">Contact us</a></li> --}}
                            <li class="cat-item"><a href="{{ route('login') }}">Login</a></li>
                            <li class="cat-item"><a href="{{ route('register') }}">Sign Up</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="widget">
                        ...
                        <div class="icon-bx-wraper style-2 m-b20">
                            ...
                            <div class="icon-content">
                                <p>Industrial Area_10 - Industrial Area - Sharjah - United Arab Emirates</p>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row align-items-center fb-inner spno">
                <div class="col-12 text-center">
                    <span class="copyright-text">Copyright © 2022 <a href="https://wa.me/201112377882"
                            class="text-primary" target="_blank">Toreya</a> All rights reserved.</span>
                </div>
            </div>
        </div>
    </div>
