<x-main-layout>
    <div class="page-content bg-white" x-data="Home">
        <div class="banner-one">
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="banner-content">
                        <h1 class="title">Discover Automotive Excellence</h1>
                        <p>Discover a world where automotive excellence and precision craftsmanship converge,
                            revolutionizing your ride and elevating your driving experience to unparalleled heights with
                            our superior quality car parts meticulously engineered for optimal performance, ensuring you
                            unleash the full potential of your vehicle and drive with unwavering confidence on every
                            journey.</p>

                        <div class="trending-box">
                            <span class="" name="cars" id="cars" style="padding: 0 1rem;cursor: pointer"
                                @click="search_url='cars'" x-transition>
                                CARS
                            </span>
                            <span class="" name="parts" id="parts" style="padding: 0 1rem;cursor: pointer"
                                @click="search_url='parts'" x-transition>
                                PARTS
                            </span>
                        </div>

                        <form :action="route" class="car-search-box row item3">

                            {{-- Brands --}}
                            <div class="col-md-3 col-sm-6">
                                <div class="selected-box">
                                    <select class="form-control" name="brand" id="brand" x-model="brand_id">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="selected-box">
                                    <select class="form-control" name="series" id="series" x-model="series_id">
                                        <option value="">choose a value</option>
                                        <template x-for="serie in series">
                                            <option :value="serie.id" x-text="serie.name"></option>
                                        </template>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                {{-- <a href="{{ route('cars.advanced-search') }}" --}}
                                <button
                                    ...
                                    <span class="d-flex justify-content-between w-100">FIND<i
                                            class="fa-solid fa-arrow-right" style="padding: 0 10px"></i></span>
                                </button>
                                {{-- </a> --}}
                            </div>
                            <img class="img2 move-2" src="/assets/images/pattern/pattern5.png " alt="">
                        </form>
                        <a :href="route" class="btn-link-lg">Try advanced search<i
                                        ...
                                        <div class="dlab-slide-item">
                                            <div class="silder-content">
                                                <div class="inner-content">
                                                    <div class="left">
                                                        <p class="car-name slide-vertical" data-splitting>
                                                            {{ $swiper->title }}</p>
                                                    </div>
                                                    <div class="right">
                                                ...
                                                <a href="/advanced-search" data-splitting class="discover-link">DISCOVER
                                                    MORE</a>
                                            </div>
            ...
            <div class="container">
                <div class="row about-bx1">
                    ...
                    <div class="col-lg-7 align-self-center">
                        ...
                        <p>Partsnoon is your trusted destination for quality used cars and car parts. We connect buyers
                            and sellers, providing a reliable marketplace for automotive enthusiasts. Our platform
                            simplifies the process of finding the right parts or pre-owned vehicles, ensuring a seamless
                            experience for all automotive needs. Discover great deals and a wide selection, all backed
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="icon-bx-wraper style-1 hover-overlay-effect">
                                        ...
                                        <div class="icon-content">
                                            <h4 class="title"><a href="/about-us.html" class="text-effect-1"
                                                    data-splitting>QUALITY PARTS</a></h4>
                                            <p>Your destination for high-quality car parts. Find the perfect components
                                                for your vehicle and keep it running smoothly.</p>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="icon-bx-wraper style-1 hover-overlay-effect">
                                        ...
                                        <div class="icon-content">
                                            <h4 class="title"><a href="/about-us.html" class="text-effect-1"
                                                    data-splitting>WIDE SELECTION</a></h4>
                                            <p>Explore our vast and diverse range of used car parts, ensuring you find
                                                the right fit and solution for your automotive needs.</p>
                                        </div>
                                        <div class="effect bg-primary"></div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="icon-bx-wraper style-1 hover-overlay-effect">
                                        ...
                                        <div class="icon-content">
                                            <h4 class="title"><a href="/about-us.html" class="text-effect-1"
                                                    data-splitting>RELIABLE SOURCES</a></h4>
                                            <p>We source our car parts from trusted sources, ensuring you receive
                                                products of the highest quality and reliability.</p>
                                        </div>
                                        <div class="effect bg-primary"></div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="icon-bx-wraper style-1 hover-overlay-effect">
                                        ...
                                        <div class="icon-content">
                                            <h4 class="title"><a href="/about-us.html" class="text-effect-1"
                                                    data-splitting>FAST SHIPPING</a></h4>
                                            <p>Enjoy quick and reliable shipping services, ensuring you receive your
                                                ordered parts promptly and in excellent condition.</p>
                                        </div>
                                        <div class="effect bg-primary"></div>
                                    </div>
                                </div>
                ...
                <div class="row features-box">
                    <div class="col-lg-6 align-self-center m-b30">
                        <div class="content-box">
                            ...
                            <a href="/assets/about-us.html" class="btn btn-primary effect-1"><span>Discover
                                    More</span></a>
                        </div>
                    </div>
                        ...
                        @foreach ($cars as $car)
                            <div class="swiper-slide">
                                <div class="car-list-box overlay">
                                    ...
                                    <div class="list-info">
                                        <h3 class="title"><a href="/assets/car-details.html" data-splitting
                                                class="text-white">{{ $car->car_name }}</a></h3>
                                        <span class="badge m-b30">{{ $car->price }} $</span>
                                        <div class="feature-list">
                                            <div>
                                                <label>Transmotion</label>
                                                <p class="value">{{ $car->gearbox }}</p>
                                            </div>
                                            <div>
                                                <label>Fuel</label>
                                                <p class="value">{{ $car->fuel_type }}</p>
                                            </div>
                                            <div>
                                                <label>Passenger</label>
                                                <p class="value">{{ $car->no_passengers }}</p>
                                            </div>
                                            <div>
                                                <label>Mileage</label>
                                                <p class="value">{{ $car->mileage }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row features-box">
                    ...
                    <div class="col-lg-6 align-self-center m-b30">
                        <div class="content-box right">
                            ...
                            <p class="m-b40">At Partsnoon, we introduce you to a future of automotive innovation.
            ...
            <div class="container">
                <div class="row call-to-action-bx">
                    <div class="col-xl-5 col-lg-6 me-auto">
                        ...
                        <a href="/assets/tel:224000221133" class="btn btn-white me-3 mb-2"><i
                                class="fas fa-phone-volume me-sm-3 me-0 shake"></i><span
                                class="d-sm-inline-block d-none">224 000 22 11 33</span></a>
                        <a href="/assets/contact-us.html" class="btn btn-outline-white effect-1  mb-2"><span>Contact
                                Us</span></a>
                    </div>
                    <div class="col-lg-6">
                        <div class="media-box">
