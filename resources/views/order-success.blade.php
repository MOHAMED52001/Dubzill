...
<head>
    ...
    <link rel="stylesheet"
        href="/assets/user/css/A.bootstrap.min.css+LineIcons.3.0.css,Mcc.kvbj5TfNfN.css.pagespeed.cf.IUMPrtes4_.css" />
...
<body>
    <noscript>
        <meta HTTP-EQUIV="refresh"
            content="0;url='https://demo.graygrids.com/themes/shopgrids/mail-success.html?PageSpeed=noscript'" />
        <style>
            <!--table,div,span,font,p{display:none}
            -->
        </style>
        <div style="display:block">Please click <a
                href="https://demo.graygrids.com/themes/shopgrids/mail-success.html?PageSpeed=noscript">here</a> if you
            ...
            <div class="d-table-cell">
                <div class="container">
                    <div class="success-content">
                        ...
                        <h5>Total Price: <span>AED {{ $total }} </span></h5>
                        <br>
                        <div class="button">
