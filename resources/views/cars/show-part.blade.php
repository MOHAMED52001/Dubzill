    ...
    <nav aria-label="breadcrumb" class="breadcrumb-row">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="advanced-search">Parts Collections</a></li>
                <li class="breadcrumb-item">{{ $part->name }}</li>
            </ul>
        </div>
    </nav>
    <!-- Breadcrumb row END -->
                ...
                <div class=" col-xl-8 col-lg-7 col-md-6 m-b0 m-md-b50">
                                        ...
                                        align-items: center;">
                                            ...
                                            <div class="overlay-bx">
                                                <div class="overlay-icon">
                                                    <span data-exthumbimage="{{ $image }}"
                                                        data-src="{{ $image }}" class="view-btn lightimg">
                    ...
                    <div class="m-b50">
                        <div class="dlab-post-title">
                            <h3 class="post-title"><a href="javascript:void(0);">{{ $part->name }}</a></h3>
                            {{-- <h6 class="sub-title">{{ $part }}</h6> --}}
                            <p class="m-b10">{{ $part->description }}</p>
                            <div class="dlab-divider bg-gray tb15">
                                <i class="icon-dot c-square"></i>
                            </div>
                        </div>
                        <script>
                            function shareCurrentPageUrl(platform) {
                                var currentPageUrl = window.location.href;
                                console.log(currentPageUrl);
                                // Customize based on the platform (e.g., open a new window with a share URL)
                                if (platform === 'facebook') {
                                    // Replace 'your-facebook-share-url' with the actual Facebook share URL
                                    var facebookShareUrl = 'https://www.facebook.com/sharer.php?u=' + encodeURIComponent(currentPageUrl);
                                    window.open(facebookShareUrl, '_blank');
                                } else if (platform === 'twitter') {
                                    // Replace 'your-twitter-share-url' with the actual Twitter share URL
                                    var twitterShareUrl = 'https://twitter.com/intent/tweet?url=' + encodeURIComponent(currentPageUrl);
                                    window.open(twitterShareUrl, '_blank');
                                } else if (platform === 'linkedin') {
                                    // Replace 'your-linkedin-share-url' with the actual LinkedIn share URL
                                    var linkedinShareUrl = 'https://www.linkedin.com/shareArticle?url=' + encodeURIComponent(currentPageUrl);
                        ...
                        <div class="social-list">
                            ...
                            <ul>
                                <li>
                                    <p style="cursor: pointer;" href="javascript:void(0);"
                                        onclick="shareCurrentPageUrl('linkedin');">
                                ...
                                <li>
                                    <p style="cursor: pointer;" href="javascript:void(0);"
                                        onclick="shareCurrentPageUrl('twitter');">
                                ...
                                <li>
                                    <p style="cursor: pointer;" href="javascript:void(0);"
                                        onclick="shareCurrentPageUrl('facebook');">
                    ...
                    <div class="dlab-tabs  product-description">
                        <ul class="nav nav-tabs m-b20">
                            <li><a data-bs-toggle="tab" href="#specifications" class="active">Specifications</a>
                            </li>
                        </ul>
                        <div class="tab-content" style="margin: 0 0 45px 0;">
                            <div id="specifications" class="tab-pane active">
                                <div class="dlab-accordion" id="accordion1">
                                        ...
                                        <div id="car-specifications" class="acod-body collapse show in">
                                            <div class="acod-content">
                                                <ul class="table-dl clearfix">
                                                    <li>
                                                        <div class="leftview">Suitable Car</div>
                                                        <div class="rightview"><a
                                                                href="/cars/{{ $part->car_id }}/details">
                                                                {{ App\Models\Car::find($part->car_id)->name }} </a>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Description</div>
                                                        <div class="rightview">{{ $part->description }}</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Status</div>
                                                        <div class="rightview">{{ $part->status }}</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Code</div>
                                                        <div class="rightview">{{ $part->code }}</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Stock Available</div>
                                                        <div class="rightview">{{ $part->count }}</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Warranty</div>
                                                        <div class="rightview">{{ $part->warranty }}</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Sale</div>
                                                        <div class="rightview"><b
                                                                style="font-weight: 800">{{ $part->sale_amount }}%</b>
                                                            For Every <b
                                                                style="font-weight: 800">{{ $part->sale_price }}
                                                                Parts</b></div>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    {{-- <div class="panel">
                                        <div class="acod-head">
                                            <h5 class="acod-title">
                                                <a data-bs-toggle="collapse" href="#engine-specifications"
                                                    class="collapsed">
                                        ...
                                        <div id="engine-specifications" class="acod-body collapse">
                                            <div class="acod-content">
                                                <ul class="table-dl clearfix">
                                                    <li>
                                                        <div class="leftview">Engine Type</div>
                                                        <div class="rightview">TurboCharged CommonRail D</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Displacement</div>
                                                        <div class="rightview">1968</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Max Power</div>
                                                        <div class="rightview">141bhp@4000rpm</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Max Torque</div>
                                                        <div class="rightview">340Nm@1750-2750rpm</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">No Of Cylinder</div>
                                                    ...
                                                    <li>
                                                        <div class="leftview">Valve Configuration</div>
                                                        <div class="rightview">DOHC</div>
                                                    </li>
                                                    <li>
                                    ...
                                    <div class="panel">
                                        <div class="acod-head">
                                            <h5 class="acod-title">
                                                <a data-bs-toggle="collapse" href="#car-dimensions"
                                                    class="collapsed">
                                                    Car Dimensions
                                                </a>
                                            </h5>
                                            ...
                                            <div class="acod-content">
                                                <ul class="table-dl clearfix">
                                                    <li>
                                                        ...
                                                        <div class="rightview">4486mm</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Width</div>
                                                        <div class="rightview">1839mm</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Height</div>
                                                        <div class="rightview">1672mm</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Ground Clearance</div>
                                                        <div class="rightview">149mm</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Wheel Base</div>
                                                        <div class="rightview">2677mm</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Front Tread</div>
                                                        <div class="rightview">1578mm</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Rear Tread</div>
                                                        <div class="rightview">1568mm</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Kerb Weight</div>
                                                        <div class="rightview">1720kg</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Gross Weight</div>
                                                        <div class="rightview">2250kg</div>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    <div class="sticky-top">
                        <div class="car-dl-info icon-bx-wraper style-1 m-b50">
                            <div class="price m-b30">
                                <h3 class="">Price {{ $part->price }} AED</h3>
                                <span style="text-decoration: line-through;">{{ $part->old_price }} AED</span>
                            </div>
                            ...
                            <div class="clearfix">
                                ...
                                <form action="{{ route('addToCart') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="validationCustom01">Number of products</label>
                                        <input type="number" class="form-control" id="validationCustom01"
                                            placeholder="Number of products"
                                            @if ($cartCount == 0) value="1"
                                            @elseif ($cartCount > 0)
                                                value="{{ $cartCount }}" @endif
                                            min="1" name="count">
                        ...
                        <div class="used-car-features clearfix m-b50">
                            <div class="car-features">
                                <svg class="mt-2 mb-3" enable-background="new 0 0 32 32" height="28px"
                                    id="Layer_3" version="1.1" viewBox="0 0 32 32" xml:space="preserve"
                                    ...
                                    <g id="calendar_1_">
                                        <path
                                            ...
                                            fill="#333332"></path>
                                        <rect fill="#333332" height="3" width="4" x="7"
                                            y="12"></rect>
                                        <rect fill="#333332" height="3" width="4" x="7"
                                            y="17"></rect>
                                        <rect fill="#333332" height="3" width="4" x="7"
                                            y="22"></rect>
                                        <rect fill="#333332" height="3" width="4" x="14"
                                            y="22"></rect>
                                        <rect fill="#333332" height="3" width="4" x="14"
                                            y="17"></rect>
                                        <rect fill="#333332" height="3" width="4" x="14"
                                            y="12"></rect>
                                        <rect fill="#333332" height="3" width="4" x="21"
                                            y="22"></rect>
                                        <rect fill="#333332" height="3" width="4" x="21"
                                            y="17"></rect>
                                        <rect fill="#333332" height="3" width="4" x="21"
                            ...
                            <div class="car-features">
                                <svg class="mt-2 mb-3" data-name="Capa 1" height="32px" id="Capa_1"
                                ...
                                <h6>{{ $part->mileage }} km</h6>
                                <span>Driven</span>
                            </div>
                            <div class="car-features">
                                <svg class="mt-2 mb-3" enable-background="new 0 0 24 24" height="32"
                                    id="Layer_4" version="1.1" viewBox="0 0 24 24" xml:space="preserve"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <g>
                                ...
                                <h6>{{ $part->fuel_type }}</h6>
                                <span>Fuel</span>
                            </div>
                            <div class="car-features">
                                <svg class="mt-2 mb-3" id="Lineal" viewBox="0 0 512 512" height="32px"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <title></title>
                            ...
                            <div class="car-features">
                                <svg class="mt-2 mb-3" enable-background="new 0 0 32 32" height="28"
                                    id="Layer_5" version="1.1" viewBox="0 0 32 32" xml:space="preserve"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <g id="calendar_2_">
                                        <path
                                            d="M29.334,3H25V1c0-0.553-0.447-1-1-1s-1,0.447-1,1v2h-6V1c0-0.553-0.448-1-1-1s-1,0.447-1,1v2H9V1   c0-0.553-0.448-1-1-1S7,0.447,7,1v2H2.667C1.194,3,0,4.193,0,5.666v23.667C0,30.806,1.194,32,2.667,32h26.667   C30.807,32,32,30.806,32,29.333V5.666C32,4.193,30.807,3,29.334,3z M30,29.333C30,29.701,29.701,30,29.334,30H2.667   C2.299,30,2,29.701,2,29.333V5.666C2,5.299,2.299,5,2.667,5H7v2c0,0.553,0.448,1,1,1s1-0.447,1-1V5h6v2c0,0.553,0.448,1,1,1   s1-0.447,1-1V5h6v2c0,0.553,0.447,1,1,1s1-0.447,1-1V5h4.334C29.701,5,30,5.299,30,5.666V29.333z"
                            ...
                            <div class="car-features">
                                <svg class="mt-2 mb-3" enable-background="new 0 0 50 50" height="32px"
                                    ...
                                    <line fill="none" stroke="#000000" stroke-linecap="round"
                                        stroke-miterlimit="10" stroke-width="2" x1="1.61" x2="18.282"
                                        y1="46.39" y2="29.718"></line>
                                </svg>
                                <h6>{{ $part->status }}</h6>
                                <span>Status</span>
                            </div>
                        ...
                        <div class="widget-title">
                            <h5 class="title">You May Also Likes</h5>
                            <div class="dlab-separator style-1 text-primary mb-0"></div>
                        </div>
                        <div class="swiper-container prev-list-slider swiper-btn-lr lightgallery">
                            <div class="swiper-wrapper mb-5">
                                @foreach ($relatedParts as $relatedPart)
                                    <div class="swiper-slide">
                                        <div class="car-list-box border">
                                            <div class="media-box">
                                                <img src="/assets/images/product/grid/pic3.jpg" alt="">
                                                <div class="overlay-bx">
                                                    <span data-exthumbimage="/assets/images/product/grid/pic3.jpg"
                                                        data-src="/assets/images/product/grid/pic3.jpg"
                                            ...
                                            <div class="list-info">
                                                <h4 class="title mb-0"><a
                                                        href="/parts/{{ $relatedPart->id }}/details" data-splitting
                                                        class="text-white">{{ $relatedPart->name }}</a></h4>
                                                {{-- <div class="car-type">SPORT CAR</div> --}}
                                                <span class="badge m-b30">AED {{ $relatedPart->price }}</span>
                                                <div class="feature-list">
                                                    <div>
                                                        <label>Status</label>
                                                        <p class="value">{{ $relatedPart->status }}</p>
                                                    </div>
                                                    <div>
                                                        <label>Warranty</label>
                                                        <p class="value"> {{ $relatedPart->warranty }} KM</p>
                                                    </div>
                                                    <div>
                                                        <label>Sale Amount</label>
                                                        <p class="value">{{ $relatedPart->sale_amount }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="btn-prev swiper-button-prev2"><i class="fa-solid fa-chevron-left"></i></i>
                            </div>
                            <div class="btn-next swiper-button-next2"><i class="fa-solid fa-chevron-right"></i></i>
                            </div>
                        </div>
                    </div>
                </div>
