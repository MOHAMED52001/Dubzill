    ...
    <nav aria-label="breadcrumb" class="breadcrumb-row">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="advanced-search">Car Collections</a></li>
                <li class="breadcrumb-item">{{ $car->car->name }}</li>
            </ul>
        </div>
    </nav>
    <!-- Breadcrumb row END -->
                ...
                <div class=" col-xl-8 col-lg-7 col-md-6 m-b0 m-md-b50">
                    ...
                    <div class="m-b50">
                        <div class="dlab-post-title">
                            <h3 class="post-title"><a href="javascript:void(0);">{{ $car->car->name }}</a></h3>
                            {{-- <h6 class="sub-title">{{ $car }}</h6> --}}
                            <p class="m-b10">{{ $car->car->description }}</p>
                                            ...
                                            <div class="acod-content">
                                                <ul class="table-dl clearfix">
                                                    <li>
                                                        ...
                                                        <div class="rightview">{{ $car->model }}</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Color</div>
                                                        <div class="rightview">{{ $car->color }}</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Gear Box</div>
                                                        <div class="rightview">{{ $car->gearbox }}</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Number of Passengers</div>
                                                        <div class="rightview">{{ $car->no_passengers }}</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Status</div>
                                                        <div class="rightview">{{ $car->status }}</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">MileAge</div>
                                                        <div class="rightview">{{ $car->mileage }}</div>
                                                    </li>
                                                    <li>
                                                        <div class="leftview">Fuel Type</div>
                                                        <div class="rightview">{{ $car->fuel_type }}</div>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    <div class="sticky-top">
                        <div class="car-dl-info icon-bx-wraper style-1 m-b50">
                            <div class="price m-b30">
                                <h3 class="">Price AED {{ $car->price }}</h3>
                                <span style="text-decoration: line-through;">{{ $car->old_price }}</span>
                            </div>
                            <form>
                                ...
                                <div class="clearfix">
                                    {{-- {{request()->fullUrl()}} --}}
                                    <a href="https://api.whatsapp.com/send?phone=+201112377882&text=Hello Sir,%0A{{ request()->fullUrl() }}%0A,%20I%20have%20seen%20this%20product%20on%20your%20website%20and%20I%20would%20like%20to%20know%20more%20about%20the%20details."
                                        class="btn-primary btn btn-block text-light mt-5" data-toggle="modal"
                                        data-target="#car-details">Contact with Seller <i
                                            class="fa-brands fa-whatsapp m-2 "></i></a>
                                </div>
                            </form>
                        </div>
                                ...
                                @foreach ($relatedCars as $relatedCar)
                                    <div class="swiper-slide">
                                        <div class="car-list-box border">
                                            ...
                                            <div class="list-info">
                                                <h4 class="title mb-0"><a href="/cars/{{ $relatedCar->id }}/details"
                                                        data-splitting
                                                        class="text-white">{{ $relatedCar->car->name }}</a></h4>
                                                {{-- <div class="car-type">SPORT CAR</div> --}}
                                                <span class="badge m-b30">AED {{ $relatedCar->price }}</span>
                                                <div class="feature-list">
                                                    <div>
                                                        <label>Transmotion</label>
                                                        <p class="value">{{ $relatedCar->gearbox }}</p>
                                                    </div>
                                                    <div>
                                                        <label>MileAge</label>
                                                        <p class="value"> {{ $relatedCar->mileage }} KM</p>
                                                    </div>
                                                    <div>
                                                        <label>Passenger</label>
                                                        <p class="value">{{ $relatedCar->no_passengers }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
